...
//	private DataSource dataSource;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String query = "SELECT s.id, s.name, s.birthyear, GROUP_CONCAT(m.id, ';',m.title SEPARATOR ', ') AS movies FROM stars s, movies m, stars_in_movies sm WHERE s.id = sm.starId and m.id = sm.movieId and s.id = ?";
